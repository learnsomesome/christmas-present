...
const MusicMemories = () => {
  ...
  const list = [
    ...
    },
    {
      ...
      content: (
        <React.Fragment>
          ...
          <p>想到刚认识时我们无话不谈，互相取暖。那真的是一段很特别的时光。</p>
          <p>倒不是说现在我们交流少了而渐行渐远。反而觉得我们始终有一层羁绊。</p>
          <p>是小羊和阿蕉，或是呆宝和我。</p>
          <p>虽然都过着自己的生活。但只要想到彼此，他/她都会在那不是么。</p>
          <p>我始终感谢缘分，让我们结识。</p>
        </React.Fragment>
      ),
      img: "di",
    ...
    },
    {
      ...
      content: (
        <React.Fragment>
          <p>不知道写什么了，好像很少说我自己。</p>
          <p>年底公司裁了人，但也没招人，所以活都匀到我们头上了。</p>
          <p>大环境还是不好，可也不是不努力的理由，逼自己多做些准备。</p>
          <p>最近也有在坚持健身，刻意的多吃一些肉蛋奶。</p>
          <p>早上一根玉米，一个鸡蛋，一杯豆浆。中午随意碳水。晚上沙县鸡腿饭。</p>
          <p>先坚持坚持，能重回刚毕业时我的脸型么，现在有点肉了哈哈。</p>
          <p>家里还是催着找对象，最近又有好多同学结婚。</p>
          <p>其实去年年底有试着接触，但都不尽人意，还是让缘分发力吧哈哈。</p>
          <p>想让自己变得再好一些，能够以最满意的状态站在你面前。</p>
          <p>如果有机会，今年我想去见你一面。</p>
          <p>嗯。就先到这里吧。希望你一切都好。</p>
        </React.Fragment>
      ),
      img: "nian",
      music: "nian",
